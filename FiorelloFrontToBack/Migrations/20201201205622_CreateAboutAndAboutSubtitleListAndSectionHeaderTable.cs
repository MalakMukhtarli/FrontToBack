...
{
    public partial class CreateAboutAndAboutSubtitleListAndSectionHeaderTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AboutSubtitleLists", x => x.Id);
                });
